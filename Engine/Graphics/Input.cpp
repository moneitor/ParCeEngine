...
Input::Input()
	:m_keyUp{0}, m_mouseWheel{0}, m_keyDown{0}, m_isXClicked{false}, m_isKeyPressed{false},
	m_isLeftButtonClicked{false}, m_isRightButtonClicked{false},
	m_isMiddleButtonClicked{false}, m_mouseMotionX{0}, m_mouseMotionY{0},
	m_mousePositionX{0}, m_mousePositionY{0}
...
void Input::Update()
{
	...
	SDL_Event events;
	SDL_TouchFingerEvent touchEvents;

...
public:
    ...
    float SetXX(float value);
    float SetXY(float value);
    float SetXZ(float value);
    float SetXW(float value);
    float SetYX(float value);
    float SetYY(float value);
    float SetYZ(float value);
    float SetYW(float value);
    float SetZX(float value);
    float SetZY(float value);
    float SetZZ(float value);
    float SetZW(float value);
    float SetWX(float value);
    float SetWY(float value);
    float SetWZ(float value);
    float SetWW(float value);

    pMat3 Minor(const int i, const int j) const;
    float Determinant() const;
    inline pMat4 Transpose() const;
...
inline pVec4 operator * (const pMat4 &mat, const pVec4 &vec);
inline pVec4 operator * (const pVec4 &vec, const pMat4 &mat);
